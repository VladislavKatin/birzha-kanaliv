...
import { getBlogArticleBySlug, getBlogVisualSectionPaths, getRelatedBlogArticles } from '../../services/blogArticles';
import {
    applyJsonLd,
    applyPageSeo,
...
function getSectionVisual(article, sectionIndex, heading) {
    ...
    const paths = getBlogVisualSectionPaths(article.slug);
    const src = paths[sectionIndex];
    if (!src) {
        return null;
    }
