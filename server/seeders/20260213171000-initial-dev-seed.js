    ...
    async up(queryInterface) {
        ...
        const users = [
            ...
            },
            {
                ...
                photoURL: null,
                bio: 'Demo profile for showcase.',
                location: 'Warsaw, PL',
                languages: JSON.stringify(['en']),
                birthYear: 1992,
                gender: null,
                professionalRole: 'Demo Creator',
                companyName: null,
                website: null,
                socialLinks: JSON.stringify({}),
                privacySettings: JSON.stringify({}),
        ...
        const channels = [
            ...
            },
            {
                ...
                channelTitle: 'Travel Byte UA [DEMO]',
                channelAvatar: 'https://api.dicebear.com/9.x/shapes/svg?seed=TravelByteUA',
                description: 'DEMO channel: short city guides, cheap routes and practical travel hacks.',
                subscribers: 38900,
                totalViews: 2840000,
                totalVideos: 154,
                avgViews30d: 27000,
            ...
            },
            {
                ...
                channelTitle: 'GameForge Highlights [DEMO]',
                channelAvatar: 'https://api.dicebear.com/9.x/shapes/svg?seed=GameForgeHighlights',
                description: 'DEMO channel: competitive gameplay breakdowns and reaction clips.',
                subscribers: 61500,
                totalViews: 5120000,
                totalVideos: 331,
                avgViews30d: 45000,
            ...
            },
            {
                ...
                channelTitle: 'Culinary Sprint [DEMO]',
                channelAvatar: 'https://api.dicebear.com/9.x/shapes/svg?seed=CulinarySprint',
                description: 'DEMO channel: 10-minute recipes, meal prep and kitchen productivity.',
                subscribers: 47200,
                totalViews: 3620000,
                totalVideos: 210,
                avgViews30d: 32500,
            ...
            },
            {
                ...
                channelTitle: 'STEM Spark Kids [DEMO]',
                channelAvatar: 'https://api.dicebear.com/9.x/shapes/svg?seed=STEMSparkKids',
                description: 'DEMO channel: fun science experiments for kids and parents.',
                subscribers: 29800,
                totalViews: 1910000,
                totalVideos: 140,
                avgViews30d: 18000,
        ...
        const offers = [
            ...
            },
            {
                ...
                type: 'subs',
                description: 'DEMO offer: travel vlog cross-promo with short-form hooks.',
                niche: 'travel',
                language: 'en',
                minSubscribers: 5000,
            ...
            },
            {
                ...
                type: 'views',
                description: 'DEMO offer: exchange gaming highlight placements for weekend streams.',
                niche: 'gaming',
                language: 'en',
                minSubscribers: 7000,
            ...
            },
            {
                ...
                type: 'subs',
                description: 'DEMO offer: recipe audience swap with healthy lifestyle creators.',
                niche: 'food',
                language: 'en',
                minSubscribers: 3000,
